import{f as H,g as B,s as N,a as Y,m as I,r as P}from"./assets/quot-9ad7a2c3.js";import{i as x}from"./assets/vendor-85e7f25d.js";const S=document.querySelector(".btn-wrapper"),o=document.querySelector(".exercises-list"),n=document.querySelector(".exercises-pagination"),d=document.querySelector(".exercises-form");let f=document.querySelector(".span");S.addEventListener("change",()=>T(1));T(1);async function T(e){const t="Muscles";d.classList.add("visually-hidden");const r=S.querySelector("input:checked"),s=r?r.value:t;f.textContent=`/ ${s.toLowerCase()}`;const{results:a,page:p,totalPages:l}=(await H(s,e??1)).data;o.innerHTML=a.map(({name:u,filter:i,imgUrl:c})=>`<li
